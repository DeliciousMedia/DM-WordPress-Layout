...
$dm_plugins = array(
	'dm/dm-environment-indicators.php',
	'dm/dm-customisations.php',
);
...
add_action(
	'pre_current_active_plugins', function () use ( $dm_plugins ) {
...
add_action(
	'network_admin_plugin_action_links', function ( $actions, $plugin_file, $plugin_data, $context ) use ( $dm_plugins ) {
		if ( 'mustuse' !== $context || ! in_array( $plugin_file, $dm_plugins ) ) {
			return;
		}
